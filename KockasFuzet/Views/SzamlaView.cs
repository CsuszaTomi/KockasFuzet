...
namespace KockasFuzet.Views
{
    internal class SzamlaView
    {
        ...
        public void ShowSzamla(Szamla szamla)
        {
            ...
            Console.WriteLine($"Befizetve: {(szamla.Befizetve == null ? "Nincs befizetve" : szamla.Befizetve.ToShortDateString())}");
        ...
        static public void ShowSzamlaList(List<Szamla> szamlaList)
        {
            ...
            foreach (Szamla szamla in szamlaList)
            {
                ...
                string befizetve = (szamla.Befizetve == null ? "Nincs" : szamla.Befizetve.ToShortDateString()).PadRight(12).Substring(0, 12);
